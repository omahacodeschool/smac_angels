...
Template.create([
  {
    ...
    name: "Angel Signup",
    subject: "Thanks for being someone\'s angel!",
    ...
    subject: "Your SMAC Monkey gift has shipped!",
    ...
    subject: "SMAC Nation Information",
